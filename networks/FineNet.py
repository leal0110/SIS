...
class FineNet(nn.Module):
    def __init__(self, lateral_channel, out_shape, num_class):
        ...
        for i in range(num_cascade):
            ...
            cascade.append(self._make_layer(lateral_channel, num_cascade-i-1, size_factor[i]))
    ...
    def _make_layer(self, input_channel, num, size_factor):
        layers = []
        for i in range(num):
    ...
    def forward(self, x):
        ...
        # print(fine_fms[0].shape)
        # print(fine_fms[1].shape)
        # print(fine_fms[2].shape)
        # print(fine_fms[3].shape)
